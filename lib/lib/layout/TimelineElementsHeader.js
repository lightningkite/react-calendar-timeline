    ...
    value: function render() {
      ...
      (0, _calendar.iterateTimes)(canvasTimeStart, canvasTimeEnd, minUnit, timeSteps, function (time, nextTime) {
        ...
        bottomHeaderLabels.push(_react2.default.createElement(
          _styleIt2.default,
          { key: 'label-style-' + time.valueOf() },
          '\n              .tooltip::before {\n                  border-color: ' + tooltipColor + ' transparent transparent transparent;\n              }\n              .tooltip::after {\n                  content: \'' + title + '\';\n                  background: ' + tooltipColor + ';\n                  width: ' + (title.length * 8 + 10) + 'px;\n              }\n            ',
          _react2.default.createElement(
            'div',
            {
              key: 'label-' + time.valueOf(),
              className: 'rct-label ' + (twoHeaders ? '' : 'rct-label-only') + ' ' + (firstOfType ? 'rct-first-of-type' : '') + ' ' + (minUnit !== 'month' ? 'rct-day-' + time.day() : '') + ' ' + (displayTooltip ? 'tooltip' : ''),
              onClick: function onClick() {
