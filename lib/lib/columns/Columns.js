  ...
  _createClass(Columns, [{
    ...
    value: function render() {
      ...
      (0, _calendar.iterateTimes)(canvasTimeStart, canvasTimeEnd, minUnit, timeSteps, function (time, nextTime) {
        ...
        var labelWidth = Math.ceil((nextTime.valueOf() - time.valueOf()) * ratio) - lineWidth + 3; // TODO: This magic 3 helps the darker blue background in the timeline not have a gap between the two lines. This is not cool feel free to fix
