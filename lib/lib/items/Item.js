      ...
      (0, _interactjs2.default)(this.item).resizable({
        ...
        if (_this2.state.resizing) {
          ...
          if (_this2.props.onResized) {
            _this2.props.onResized(_this2.itemId, resizeTime, resizeEdge, _this2.resizeTimeDelta(e, resizeEdge), _this2.props.item);
          }
          _this2.setState({
            resizing: null,
            resizeStart: null,
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getItemProps = function () {
    ...
    var classNames = 'rct-item' + (_this3.props.item.className ? ' ' + _this3.props.item.className : '') + (_this3.props.selected ? ' rct-item-selected' : '');
