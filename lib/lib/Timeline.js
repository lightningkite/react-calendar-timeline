...
var ReactCalendarTimeline = function (_Component) {
  ...
  _createClass(ReactCalendarTimeline, [{
    ...
    key: 'stackItems',
    value: function stackItems(items, allGroups, canvasTimeStart, visibleTimeStart, visibleTimeEnd, width) {
      var groups = allGroups.slice(0, 1);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            items.length === 0 && groups.length > 0 && _react2.default.createElement(
              _styleIt2.default,
              null,
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                {
                  type: 'button',
                  style: _extends({}, controlStyle, { width: '60px', right: '70px', fontSize: '12px' }),
                  onClick: function onClick() {
                    _this3.props.onTimeChange((0, _moment2.default)().subtract(15, 'days').valueOf(), (0, _moment2.default)().add(15, 'days').valueOf(), _this3.updateScrollCanvas);
                  } },
                'Today'
              ),
              _react2.default.createElement(
                ...
                {
                  type: 'button',
                  style: _extends({}, controlStyle, { right: '40px' }),
                  onClick: function onClick(e) {
                    e.preventDefault();
                    _this3.handleWheelZoom(10, 562, 10);
                  } },
                '-'
              ),
              _react2.default.createElement(
                ...
                {
                  type: 'button',
                  style: _extends({}, controlStyle, { right: '10px' }),
                  onClick: function onClick(e) {
                    e.preventDefault();
                    _this3.handleWheelZoom(10, 562, -10);
                  } },
...
ReactCalendarTimeline.propTypes = {
  ...
  daySelected: _propTypes2.default.func,
  ...
  visibleTimeStart: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.object]),
  visibleTimeEnd: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.object]),
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.daySelected = function (time) {
    if (_this4.props.daySelected) {
      _this4.props.daySelected(time);
    }
  };

  this.selectItem = function (item, clickType, e, itemObj) {
    if (_this4.state.selectedItem === item || _this4.props.itemTouchSendsClick && clickType === 'touch') {
      if (item && _this4.props.onItemClick) {
        ...
        _this4.props.onItemClick(item, e, time, itemObj);
      }
    } else {
  ...
  this.dropItem = function (item, dragTime, newGroupOrder, itemObj) {
    _this4.setState({ draggingItem: null, dragTime: null, dragGroupTitle: null });
    if (_this4.props.onItemMove) {
      _this4.props.onItemMove(item, dragTime, newGroupOrder, itemObj);
    }
  };
  ...
  this.resizedItem = function (item, resizeTime, edge, timeDelta, itemObj) {
    _this4.setState({ resizingItem: null, resizingEdge: null, resizeTime: null });
    if (_this4.props.onItemResize && timeDelta !== 0) {
      _this4.props.onItemResize(item, resizeTime, edge, itemObj);
    }
  };
  ...
  this.handleRowClick = function (e, rowIndex) {
    ...
    var groupId = null;
    if (rowIndex) {
      groupId = (0, _generic._get)(_this4.props.groups[rowIndex], _this4.props.keys.groupIdKey);
    }
